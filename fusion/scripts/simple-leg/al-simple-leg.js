 ...
 */
function createLegTube(rootComp, params) {
    ...
    const extInputRing = extrudeFeatures.createInput(ringProfile, 3 /* adsk.fusion.FeatureOperations.NewBodyFeatureOperation */);
    if (!extInputRing) {

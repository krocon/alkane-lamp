 ...
 */
function createTetrapod(rootComp, params) {
    const features = rootComp.features;
...
function addLongArmThread(rootComp, armBody, params) {
    ...
    if (facesToOffset.length > 0) {
        ...
        const offsetInput = offsetFeatures.createInput(facesToOffset, adsk.core.ValueInput.createByString("-0.1mm"));
        if (offsetInput) {
 ...
 * @param params Die Benutzerparameter.
 */
function boreOutLongArm(rootComp, params) {
